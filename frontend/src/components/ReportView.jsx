      ...
      <div className="card-body">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="stat bg-base-200 rounded-xl">
            ...
            <div className="stat-value text-primary">{report.technicalScore ?? 0}/10</div>
          </div>
          <div className="stat bg-base-200 rounded-xl">
            <div className="stat-title">DSA</div>
            <div className="stat-value text-secondary">{report.dsaScore ?? 0}/10</div>
          </div>
          <div className="stat bg-base-200 rounded-xl">
            <div className="stat-title">Communication</div>
            <div className="stat-value text-accent">{report.communicationScore ?? 0}/10</div>
          </div>
        </div>
